      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-black border-b border-green-500" style={{ borderStyle: 'dashed' }}>
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-1">
            <a href="#food" className="text-white hover:text-green-500 transition px-4 py-2 border border-white rounded">Food</a>
            <a href="#cosmetic" className="text-white hover:text-green-500 transition px-4 py-2 border border-white rounded">Cosmetic</a>
            <a href="#products" className="text-white hover:text-green-500 transition px-4 py-2 border border-white rounded">Products</a>
            <a href="#howtouse" className="text-white hover:text-green-500 transition px-4 py-2 border border-white rounded flex items-center">
              How To Use <span className="ml-1">▼</span>
            </a>
            <a href="#instructor" className="text-white hover:text-green-500 transition px-4 py-2 border border-white rounded">Certified Instructor</a>
          </nav>
